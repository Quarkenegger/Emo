...
puzzle8:{question:'Die arme Studentin weiss nicht wo er ist, wie fuehlt er sich wohl: ', answers:['frustriert','verwirrt','dumm','schlau'],picture:'studentin_verwirrt.jpg',correct:2,reward:0},
...
puzzle11:{question:'Wie sieht Jonathan aus als er ueber Rosalina spricht?', answers:['schwaermerisch','heiter','verliebt','verlegen'],picture:'Jonathan_schwaermerisch.jpg',correct:1,reward:0},
...
puzzle14:{question:'Das Buch scheint ihr wichtig zu sein, aber was empfindet sie dabei?', answers:['enttaeuscht','heiter','interessiert','ueberrascht'],picture:'studentin_interessiert.jpg',correct:3,reward:0},
...
item303:{name:'Linse', description: 'Eine Linse zum fokussieren von Licht. Perfekt um einen Laser zu bauen.',picture:'linse.jpg'},
}
...
var quests={
	...
	quest7:{name:'Befrage Helena Graf',description:'Gehe zu den Plattenbauten und finde Helena Graf. Tipp: Helena treibt sich gern auf Hinterhoefen herum.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
  ...
  quest13:{name:'Der grosse Filmpark.',description:'Gehe in den Filmpark. Dort musst du nach dem Taeter suchen. Alle Hinweise weisen auf den Professor hin, jedoch warum sollte er sowas getan haben?!.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
	quest14:{name:'Suche den Professor.',description:'Der Professor soll hier irgendwo im Filmpark befinden. Suche ihn mit hilfe der anderen Gaeste und Angesellten.',clues:['Er befindet sich im sueden-osten am Kino.'],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
