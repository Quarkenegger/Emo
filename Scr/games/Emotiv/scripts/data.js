...
map_3:{name:'Park',description:'Du bist schon sehr weit herumgekommen. Jetzt goennst Du Dir eine schoene Zeit. Im Filmpark triffst du viele Schauspieler, die ihr koennen unter Beweis stellen moechten. Sie sind Meister im Nachahmen von Emotionen. Viel Spass mit Ihnen und Ihren Kunststuecken. Auch Deine Mission steuert auf neue Erkenntisse zu. Es gibt dunkle Schaechte die so manches Geheimnis verbergen.'} ,
...
var quests={
	quest1:{name:'Erzaehle Sam und Max von dem Fall',description:'Du hast von dem Polizeichef einen wichtigen Fall uebertragen bekommen um den Taeter aus der Ausstellung [Fest der Emotionen] zu finden. Suche deine 2 Gehilfen Sam und Max und berichte ihnen davon. Tipp: Gehe in die Detektei.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
	...
	quest3:{name:'Beginne mit den Ermittlungen',description:'Befrage die Leute in der Stadt um Hinweise zu dem Taeter zu finden Tipp: Im Buerogebaeude befinden sich viele Menschen.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
	quest4:{name:'Troeste Gisela',description:'Troeste die [traurige] Gisela. Finde dazu etwas aufmunterndes. Tipp: Du hast bestimmt etwas in deinem Haus in deinen Regalen.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[4]},
	quest5:{name:'Besorge Bueromaterial',description:'Besorge [Tacker], [Bueroklammern], [Aktenordner] und [Stifte]. Tipp: Bueromaterial gibt es bestimmt im Kaufhaus.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[5,6,7,8]},
	quest6:{name:'Erkunde das Wohnviertel',description:'Befrage die Leute in dem Wohngebiet um Hinweise zu dem Taeter zu finden.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
	...
	quest8:{name:'Schutz',description:'Finde etwas um dich in gefaehrlichen Situationen zu schuetzen.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[9]},
	quest9:{name:'Die Kuenstlerin',description:'Suche im Wohnviertel nach der Kuenstlerin Yuga. Vielleicht hat sie Hinweise oder macht sich verdaechtig.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
	quest10:{name:'Die bessere Kuenstlerin',description:'Yuga verdaechtigt Hilda, bestimmt aus Neid. Du solltest trotzdem mir ihr reden.',clues:[],rewardonbeginn:[],rewardonclose:[],neededitems:[]},
